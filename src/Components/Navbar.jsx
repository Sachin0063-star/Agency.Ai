...
const Navbar = ({ theme, setTheme }) => {
 ...
 <motion.div 
  ...
  className='flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
      ...
      max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary 
...
<a href="#" className='text-sm max-sm:hidden flex cursor-pointer hover:scale-105 transition-all text-gray-700 dark:text-white'>
