...
const Footer = ({theme}) => {
  return (
    ...
    className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
      {/* footer-top */}
    ...
    viewport={{once:true}}
        ...
        className='space-y-5 text-sm text-gray-700 dark:text-gray-400'> 
            ...
            <p className='max-w-md'>From strategy to execution, we craft digital solutions that move your business forwar.</p>
    ...
    viewport={{once:true}}
      ...
      <p>Copyright 2025 © sachin sharma - All Right Reseved</p>
